...
- `l2_capable` (Boolean) Filter datacenters to only those that offer layer-2 segments.
...
- `vpc_capable` (Boolean) Filter datacenters to only those that offer VPC networking.
...
- `l2_capable` (Boolean) Whether layer-2 segments are available in this datacenter.
...
- `vpc_capable` (Boolean) Whether VPC networking is available in this datacenter.
