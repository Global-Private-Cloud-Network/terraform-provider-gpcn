...
const (
	...
	ErrDetailAPIKeyRejected  = "GPCN answered 401 to GET /v1/auth/check. The key in GPCN_API_KEY was revoked, expired, disabled, never bound to an entity, its owner left the entity, or the entity is deactivated. Mint a new key in the portal."
